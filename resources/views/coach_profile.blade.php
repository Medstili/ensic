        ...
        <div class="coach-info">
            ...
            <div class="coach-details">
                ...
                <div class="coach-tags">
                    <span class="tag speciality">{{$coach->speciality}} Coach</span>
                ...
                <div class="coach-contact">
                    ...
                    <p><i class="fas fa-phone"></i> {{$coach->tel}}</p>
                </div>
            </div>
        </div>
            ...
            <div class="modal-body">
                <form action="{{ route('user.update', $coach->id) }}" onsubmit="coachUpdatePlanning()" method="POST" class="row">
                    ...
                    <div class="form-column">
                        ...
                        <div class="form-floating">
                            <input type="number" class="form-control" id="tel" name="tel" value="{{$coach->tel}}" required>
                            ...
                            <div class="card-body">
                                ...
                                <select class="form-select" id="specialist" name="specialist" required>
                                    ...
                                    @foreach ($specialities as $speciality)
                                        <option value="{{$speciality}}" {{$coach->speciality == $speciality ? 'selected' : ''}}>{{$speciality}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
