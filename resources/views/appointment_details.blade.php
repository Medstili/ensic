...
@php
    ...
    $coach = App\Models\User::find($appointment->coach_id);
    $color = '';
        ...
        <div class="glass-card main-card">
            ...
            <div class="info-grid">
                ...
                <div class="info-card client-card">
                    ...
                    <h3>Client</h3>
                    <p><i class="fas fa-user ml-2"></i> : {{ $patient->full_name}}</p>
                    <p><i class="fas fa-phone ml-2"></i> : {{ $patient->phone }}</p>
                </div>
                ...
                <div class="info-card coach-card">
                    ...
                    <p><i class="fas fa-user ml-2"></i> : {{$coach->full_name }}</p>
                    <span class="badge-glass">{{ $appointment->choosen_speciality }}</span>
                </div>
